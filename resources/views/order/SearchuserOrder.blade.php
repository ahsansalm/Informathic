                                ...
                                @foreach($devices as $device)
                                    <form>
                                        <tr>
                                            ...
                                            <td><span class="badge bagde-sm bg-primsuccessary">{{$device->neww->admin_status}}</span></td>
                                            ...
                                            <td><span class="badge bagde-sm bg-success">{{$device->neww->admin_status}}</span></td>
                                            @else
                                            <td><span class="badge bagde-sm bg-danger">{{$device->neww->admin_status}}</span></td>
                                            @endif
